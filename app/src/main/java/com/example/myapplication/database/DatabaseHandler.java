...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private  static final String DATABASE_NAME = "HomeLibraryDb";
    ...
    public void addToCart(BookModel bookModel) {
        ...
        contentValues.put(KEY_PUBLISHED_YEAR, bookModel.getPublished_year());
    ...
    public List<BookModel> getCartItems() {
        ...
        if(cursor.moveToFirst()) {
            ...
            do {
                ...
                bookModel.setPublished_year(cursor.getString(cursor.getColumnIndex(KEY_PUBLISHED_YEAR)));
